    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-category">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-category--id-">
                                <a href="#endpoints-GETapi-category--id-">GET api/category/{id}</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-post--id-">Display the specified resource.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-page">Display a listing of the resource.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-page--id-">
                                <a href="#endpoints-GETapi-page--id-">Display the specified resource.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-category">Display a listing of the resource.</h2>
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: &quot;0197a789-e820-703f-a005-3a7b94d96b13&quot;,
        &quot;name&quot;: &quot;Technology&quot;,
        &quot;slug&quot;: &quot;technology&quot;,
        &quot;created_at&quot;: &quot;2025-06-25T14:42:02.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-06-25T14:42:02.000000Z&quot;,
        &quot;deleted_at&quot;: null
    }
]</code>
 </pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-category--id-">GET api/category/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/category/0197a789-e820-703f-a005-3a7b94d96b13" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/category/0197a789-e820-703f-a005-3a7b94d96b13"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="0197a789-e820-703f-a005-3a7b94d96b13"
               data-component="url">
    <br>
<p>The ID of the category. Example: <code>0197a789-e820-703f-a005-3a7b94d96b13</code></p>
            </div>
                    </form>
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: &quot;0197a78a-2aaa-700b-9e44-105b6da3b702&quot;,
        &quot;title&quot;: &quot;Publisher 2&quot;,
        &quot;slug&quot;: &quot;publisher-2&quot;,
        &quot;excerpt&quot;: &quot;asdasdasd&quot;,
        &quot;content&quot;: &quot;&lt;p&gt;asdasdasd&lt;/p&gt;&quot;,
        &quot;image&quot;: &quot;posts/01JYKRMAN7SRK004WH5839DEG9.png&quot;,
        &quot;status&quot;: &quot;draft&quot;,
        &quot;published_at&quot;: &quot;2025-06-25 21:42:20&quot;,
        &quot;created_at&quot;: &quot;2025-06-25T14:42:19.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-06-25T14:42:19.000000Z&quot;,
        &quot;deleted_at&quot;: null
    }
]</code>
 </pre>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-post--id-">Display the specified resource.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/post/0197a78a-2aaa-700b-9e44-105b6da3b702" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/post/0197a78a-2aaa-700b-9e44-105b6da3b702"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="0197a78a-2aaa-700b-9e44-105b6da3b702"
               data-component="url">
    <br>
<p>The ID of the post. Example: <code>0197a78a-2aaa-700b-9e44-105b6da3b702</code></p>
            </div>
                    </form>
...
<code class="language-json" style="max-height: 300px;">[
    {
        &quot;id&quot;: &quot;0197ac61-1fc3-72ae-8fcc-8c46f0dcafc6&quot;,
        &quot;title&quot;: &quot;asdasd&quot;,
        &quot;slug&quot;: &quot;asdasd&quot;,
        &quot;body&quot;: &quot;&lt;p&gt;asdsadasdasdasd&lt;/p&gt;&quot;,
        &quot;status&quot;: &quot;draft&quot;,
        &quot;created_at&quot;: &quot;2025-06-26T13:15:35.000000Z&quot;,
        &quot;updated_at&quot;: &quot;2025-06-26T13:15:40.000000Z&quot;,
        &quot;deleted_at&quot;: null
    }
]</code>
 </pre>
...
<span id="execution-results-GETapi-page" hidden>
    ...
    <pre class="json"><code id="execution-response-content-GETapi-page"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-page" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-page">
...
<form id="form-GETapi-page" data-method="GET"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
            ...
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-page"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-page--id-">Display the specified resource.</h2>
...
<span id="example-requests-GETapi-page--id-">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/page/0197ac61-1fc3-72ae-8fcc-8c46f0dcafc6" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/page/0197ac61-1fc3-72ae-8fcc-8c46f0dcafc6"
);
...
<span id="example-responses-GETapi-page--id-">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <details class="annotation">
...
<span id="execution-results-GETapi-page--id-" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-page--id-"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-page--id-"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-page--id-" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-page--id-">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-page--id-" data-method="GET"
      data-path="api/page/{id}"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-page--id-', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-page--id-"
                    onclick="tryItOut('GETapi-page--id-');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-page--id-"
                    onclick="cancelTryOut('GETapi-page--id-');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-page--id-"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-page--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-page--id-"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="GETapi-page--id-"
               value="0197ac61-1fc3-72ae-8fcc-8c46f0dcafc6"
               data-component="url">
    <br>
<p>The ID of the page. Example: <code>0197ac61-1fc3-72ae-8fcc-8c46f0dcafc6</code></p>
            </div>
                    </form>
